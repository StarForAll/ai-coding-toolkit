...
Output:
Enter the task-based runtime path, create an audit task, use the `brainstorm` mainline, emit a Codex handoff block when required, and maintain `audit-report.md` inside the task.
