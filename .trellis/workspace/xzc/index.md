...
| 334 | 2026-05-28 | Harden workflow-scan/repair false-positive guards | `19d2935` | `main` |
| 333 | 2026-05-28 | Add game strategy master agent | `237dd93` | `main` |
...
| 314 | 2026-05-26 | Fix workflow project-audit delivery gates | `eb6b3dd` | `main` |
| 313 | 2026-05-26 | Repair embedded workflow strong-gate contracts | `43f9f08`, `aafc275` | `main` |
...
| 302 | 2026-05-24 | repair embedded workflow runtime contracts and routing guidance | `e61776d`, `57a21e7` | `main` |
...
| 297 | 2026-05-23 | audit workflow strong-gate status mapping fixes | `909476d` | `main` |
...
| 292 | 2026-05-22 | 工作流审计：深度分析对原生 Trellis 的修改 | - | `main` |
...
| 260 | 2026-05-19 | 生成游戏策略大师 Agent 系统提示词 | - | `main` |
| 259 | 2026-05-19 | workflow audit fix strong-gate closure | `71a797b`, `7f8cab2` | `main` |
...
| 245 | 2026-05-18 | Refine trellis 0.5.17 enhancement retention | `0ae0a39` | `main` |
...
| 235 | 2026-05-17 | 修复工作流嵌入6项一致性问题 | `0d28f04` | `main` |
| 234 | 2026-05-17 | 修复工作流强门禁8项一致性问题 | HEAD | `main` |
...
| 226 | 2026-05-16 | Finalize workflow capability audit for Trellis 0.5.16 | `dcac0ff` | `main` |
...
| 215 | 2026-05-15 | Fix workflow-audit skill contracts | `68a6991` | `main` |
...
| 168 | 2026-05-08 | Trellis 0.5.6→0.5.7 upgrade: dispatch_mode inline, Kiro contract, template-hashes backfill | `a171f11` | `main` |
| 167 | 2026-05-08 | 修复 Trellis 0.5.6 升级缺陷：回退 trellis-research 工具简化并修正 Phase 编号 | `36a27cc` | `main` |
...
| 162 | 2026-05-07 | Trellis live 运行面漂移收敛与 template hash 恢复 | `c514780` | `main` |
...
| 151 | 2026-05-06 | Fix workflow-capability-audit execution gaps | `c82818a` | `main` |
...
| 118 | 2026-04-18 | workflow agents 子代理链收敛为工作流内单一 source-of-truth | `ab94c65` | `main` |
| 117 | 2026-04-18 | 工作流补充 trellis 原生 subagent 能力 | `aaa20b4` | `main` |
| 116 | 2026-04-18 | 工作流与 Trellis 0.4.0 兼容升级 | `19b16ec` | `main` |
...
| 84 | 2026-04-02 | 工作流一致性审查与漂移修复 | `d202f2c` | `main` |
| 83 | 2026-04-02 | 澄清 workflow 嵌入模型并补齐说明 | `383c8a4` | `main` |
...
| 49 | 2026-03-30 | 双轨交付控制验证增强 (方案B) | `b37feec` | `main` |
| 48 | 2026-03-30 | trellis-library术语与格式一致性修正 | `fb639de` | `main` |
...
| 43 | 2026-03-30 | 工作流集成 demand-risk-assessment 风险分析步骤 | `9c9075b` | `main` |
| 42 | 2026-03-30 | 新项目工作流补充 feasibility 前置门禁 | `26de251` | `main` |
...
| 33 | 2026-03-22 | 任务级多 CLI 补充审查机制与多 reviewer skill | `fadff8d`, `59bc8d9` |
...
| 1 | 2026-03-18 | Build Trellis Library Asset System | `06acc8d` |
<!-- @@@/auto:session-history -->
