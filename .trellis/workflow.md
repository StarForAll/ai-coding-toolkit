...
<!--
  ...
  Editing checklist:
    ...
    - Full runtime contract lives in the live parser/hook implementations
      under `.claude/hooks/`, `.codex/hooks/`, `.qoder/hooks/`, and
      `.opencode/plugins/`
-->
...
- `.qoder/hooks/inject-workflow-state.py` — Qoder parser implementation
