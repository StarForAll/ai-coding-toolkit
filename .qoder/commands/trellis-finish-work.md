...
description: Wrap up the current session: archive completed tasks and record session journal. Code commits must be completed in Phase 3.1 before invoking this command.
---
