...
> **Cross-CLI**: ✅ Claude Code · ✅ Cursor (命令名: brainstorm) · ⚠️ OpenCode（可原生承载；见 `opencode/README.md`） · ⚠️ Codex（可原生承载但采用 skills/agents 模型；见 `codex/README.md`） · ⚠️ Gemini（兼容层；见 `gemini/README.md`）
>
