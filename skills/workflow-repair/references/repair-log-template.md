...
- Authorization Mode: {analysis-only | authorized-to-repair | post-plan-confirmation}
- Continuation Mode: {stop-after-summary | auto-follow-through}
- Auto Follow-Through Outcome: {not-applicable | pending | reached-finish-work | stopped-with-blocker: <brief reason> | interrupted: session-did-not-complete}
...
9. If continuation mode = `auto-follow-through`, the log should also record
   whether post-repair continuation reached finish-work or stopped with a
   blocker.
