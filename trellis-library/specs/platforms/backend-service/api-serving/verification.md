...
* request-serving behavior is defined under realistic load and dependency conditions
* validation, authorization, execution, and failure boundaries remain clear
