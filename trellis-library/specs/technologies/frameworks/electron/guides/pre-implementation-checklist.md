...
| [Code Reuse Thinking Guide](./code-reuse-thinking.md)   | Patterns and abstractions | During/after implementation |
| [Cross-Layer Thinking Guide](./cross-layer-thinking.md) | Data flow across layers   | Complex feature planning    |
