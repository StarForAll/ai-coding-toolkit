...
**Key insight**: For development, run with `pnpm run start` to inherit terminal's permissions.
...
1. Run from terminal: `pnpm run start`
...
1. Development: Run with `pnpm run start` (inherits terminal permissions)
