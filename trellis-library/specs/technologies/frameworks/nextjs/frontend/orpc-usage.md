...
> Replace `@your-app/api/orpc/router` with your monorepo's oRPC router path (see [Project-Specific Placeholders](#project-specific-placeholders)).

```typescript
// lib/orpc-client.ts
import { createORPCClient, onError } from "@orpc/client";
import { RPCLink } from "@orpc/client/fetch";
import type { ApiRouterClient } from "@your-app/api/orpc/router";
